...
_main:
	...
	ar0 = 0x00
	C$Union.c$22$1_0$2 ==.
;	Union.c:22: MyVar.a_byte     = 0x05;
	mov	_MyVar,#0x05
	C$Union.c$23$1_0$2 ==.
;	Union.c:23: P1               =	MyVar.a_byte;
	mov	_P1,_MyVar
	C$Union.c$24$1_0$2 ==.
;	Union.c:24: MyVar.a_bit.bit6 = 1;
	mov	r0,#_MyVar
	mov	a,@r0
	orl	a,#0x40
	mov	@r0,a
	C$Union.c$25$1_0$2 ==.
;	Union.c:25: P1               =	MyVar.a_byte;
	mov	_P1,_MyVar
	C$Union.c$26$1_0$2 ==.
;	Union.c:26: bb               = 1;
;	assignBit
	setb	_bb
	C$Union.c$28$1_0$2 ==.
;	Union.c:28: while(1); 			/* program loop   */
00102$:
	sjmp	00102$
	C$Union.c$29$1_0$2 ==.
;	Union.c:29: }
