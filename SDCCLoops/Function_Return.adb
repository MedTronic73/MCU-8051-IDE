...
F:G$sum_while$0_0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$sum_Do$0_0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$sum_For$0_0$0({2}DF,SI:S),Z,0,0,0,0,0
S:LFunction_Return.main$My_sum$1_0$5({2}SI:S),R,0,0,[]
S:LFunction_Return.main$My_Count$1_0$5({1}SC:U),R,0,0,[]
S:LFunction_Return.sum_while$i$1_0$6({1}SC:U),E,0,0
S:LFunction_Return.sum_while$sum$1_0$6({2}SI:S),R,0,0,[r6,r7]
S:LFunction_Return.sum_Do$i$1_0$9({1}SC:U),E,0,0
S:LFunction_Return.sum_Do$sum$1_0$9({2}SI:S),R,0,0,[r6,r7]
S:LFunction_Return.sum_For$i$1_0$12({1}SC:U),E,0,0
S:LFunction_Return.sum_For$sum$1_0$12({2}SI:S),R,0,0,[r6,r7]
